    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbar1">
        <ul class="nav navbar-nav">
            ...
            <div class="dropdown-menu row col-lg-12 three-column-navbar" role="menu">
              ...
              <div class="col-md-3">
                <ul class="menu-item list-unstyled">
                  <li>
                    <a href="<?php echo base_url('genre/'.$genre->slug.''); ?>">
                      <?php echo $genre->name; ?>
                    </a>
                  </li>
                </ul>
          ...
          <li class="dropdown">
            ...
            <div class="dropdown-menu row col-lg-12 three-column-navbar" role="menu">
              ...
              <div class="col-md-3">
                <ul class="menu-item list-unstyled">
                  <li>
                    <a href="<?php echo base_url('country/'.$country->slug.''); ?>">
          ...
          <li class="dropdown">
            ...
            <div class="dropdown-menu row col-lg-12 three-column-navbar" role="menu">
              ...
              <div class="col-md-3">
                <ul class="menu-item list-unstyled">
                  <li>
                    <a href="<?php echo base_url('year/'.$i.''); ?>">
                      <?php echo $i; ?>
                    </a>
                  </li>
                </ul>
              ...
              <div class="col-md-3">
                <ul class="menu-item list-unstyled">
                  <li>
                    <a href="<?php echo base_url('year'); ?>">More..
                    </a>
                  </li>
                </ul>
              </div>
          ...
          <?php endif; ?>
          <li>
            <a href="<?php echo base_url('movies')?>">Movies
            </a>
          </li>
          <?php
          ...
          ?>
          <li>
            <a href="<?php echo base_url('tv-series')?>">TV Series
            </a>
          </li>
          <?php endif; ?>
          <?php
