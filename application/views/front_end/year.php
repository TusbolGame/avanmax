        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="page-title">
                    <h1 class="text-uppercase">Películas del Año: <?php echo $year; ?></h1>
                </div>
            </div>
...
<div id="section-opt">
    <div class="container">
        <div class="row">
            ...
            <!-- End All Movies -->
        <?php else: echo "<h3 class='text-center text-uppercase'>No encontramos películas para el Año:  ".$year."</h3>"; endif; ?>
        </div>
