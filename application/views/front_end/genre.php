        ...
        <div class="row">
            <div class="col-md-9 col-sm-8 col-xs-12">
                <div class="page-title">
                    <h1 class="text-uppercase">Género: <?php echo $genre_name; ?></h1>
                </div>
            </div>
...
<div id="section-opt">
    <div class="container">
        <div class="row">
            ...
            <!-- End All Movies -->
            <?php else: echo "<h3 class='text-center text-capitalize'>No encontramos películas para ".$genre_name."</h3>"; endif; ?>
        </div>
