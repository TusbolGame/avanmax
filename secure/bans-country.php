...
<table id="dt-basic" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
									<thead>
										<tr>
											...
											<th><i class="fas fa-list-alt"></i> Status</th>
...
';
    if ($row['countryban_blacklist'] == 0) {
        echo '<h5><span class="badge badge-success">Whitelisted</span></h5>';
    } else {
        echo '<h5><span class="badge badge-danger">Blacklisted</span></h5>';
    }
    echo '
											</td>
											<td>
