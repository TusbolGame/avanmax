...
CREATE TABLE `<DB_PREFIX>bans-ranges` (
  `id` int(11) NOT NULL AUTO_INCREMENT primary key,
  `ip_range` char(11) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
(11, 'iframe_out', 0, 0, ''),
(12, 'selecting', 0, 0, ''),
(13, 'developer_tools', 0, 1, 'It is not allowed to use Developer Tools (Console)');
...
(3, 'Proxy', 'Access to the website via Proxy is not allowed (Disable Browser Data Compression if you have it enabled)'),
...
CREATE TABLE `<DB_PREFIX>settings` (
  ...
  `badword_replace` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT '[Censored]',
...
INSERT INTO `<DB_PREFIX>settings` (`id`, `email`, `username`, `password`, `realtime_protection`, `mail_notifications`, `ip_detection`, `countryban_blacklist`, `live_traffic`, `jquery_include`, `badword_replace`, `error_reporting`, `display_errors`, `fixed_layout`, `boxed_layout`) VALUES
(1, 'admin@mail.com', 'admin', '', 1, 1, 1, 1, 0, 0, '[Censored]', 5, 0, 0, 0);
