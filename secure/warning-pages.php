                     ...
                     <div class="card text-center">
						 <div class="card-header">
								<ul class="nav nav-tabs card-header-tabs">
									...
									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#banned-layout">Banned IP</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#bannedc-layout">Banned Country</a>
									</li>
                                    <li class="nav-item">
										<a class="nav-link" data-toggle="tab" href="#bannedbr-layout">Blocked Browser</a>
									</li>
                                    <li class="nav-item">
